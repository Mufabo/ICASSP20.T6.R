  ...
  for(ii_eps in 1:eps_iter){
    for(iEmBic in 1:embic_iter){
        for(ll in 1:L_max){
          ...
          bic_final[iMC, i_eps, ll, ,iEmBic] <- c(bicf$bic, bica$bic, bics$bic)
          like_final[iMC, i_eps, ll, ,iEmBic] <- c(bicf$like, bica$like, bics$like)
          pen_final[iMC, i_eps, ll, ,iEmBic] <- c(bicf$pen, bica$pen, bics$pen)
        }
    }
  } 
}    
